...
<div class="app-content" style="padding-bottom: 24px">
  <div>
    <h1 class="app-content-headerText">Update Job Vacancy</h1>
  </div>
  <div></div>
  <br />
  ...
  <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
    ...
    <div class="form-group">
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          <input class="form-control input-sm" id="OCCUPATIONTITLE" name="OCCUPATIONTITLE"
            placeholder="Occupation Title" autocomplete="none" value="<?php echo $res->OCCUPATIONTITLE; ?>" />
        </div>
      </div>
    </div>
      ...
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          <input class="form-control input-sm" id="DURATION_EMPLOYEMENT" name="DURATION_EMPLOYEMENT"
            placeholder="Duration of Employment" autocomplete="none" value="<?php echo $res->DURATION_EMPLOYEMENT ?>" />
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          <textarea class="form-control input-sm" id="JOBDESCRIPTION" name="JOBDESCRIPTION"
            placeholder="Job Description" autocomplete="none"><?php echo $res->JOBDESCRIPTION ?></textarea>
        </div>
      </div>
    </div>
